...
export default function Navbar(props) {
  return (
    ...
    <div className="container-fluid">
      ...
      {/* green or white mode */}
      <div className={`form-check form-switch text-${props.mode1==='light'?'success':'light'} me-2`}>
...
// jo App.js ma Navbar ma title set no karyu hoy to automatic deault title set thay jay
Navbar.defaultProps = {
    title : "This is defaullt tite"
}